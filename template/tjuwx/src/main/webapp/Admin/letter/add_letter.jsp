    ...
    <div class="container">
        ...
        <div class="block">
            ...
            <div class="message" id="actionmessage">
                <font color="#000000"><s:actionmessage cssClass="alert alert-success"/></font>
                <font color="#ff0000"><s:actionerror cssClass="alert alert-danger"/></font>
            </div>
            <div class="message">
...
<script type="text/javascript">
	...
	function check(){
		...
		if($("#receiver").val() == ""){
			...
			$("#js_message").html("<div class='alert alert-danger'>收件人不能为空</div>");
